...
author: "Cyrus Elahi"
date: "2024-11-08"
categories: [Subis, medical students, rotations]
image: "bfox_gown.png"
---

While it's not hard to do well on a sub-I, only a few students standout every month. Below are some simple tips to help you succeed during a sub-I..

## Tips

-   **Be team player** - Play well with other rotating medical students. Do not steal cases, answer questions asked to another student (unless you are directly asked), or show up the residents (e.g. if the chief asks a question to a resident, do not correct the resident if they did not know - this actually happens). Residents notice. Also, be willing to help the staff and nurses. This help may include moving patients, opening doors, or answering the phone. With these, you do not want to take the job of another, so read the room. But if a nurse's hands are full, and you can help, do so.

-   **Be kind** - Please and thank you go a long away. Treat the patients well.

-   **Take feedback** - You will receive consistent feedback on your rotation, that is the point. Take this feedback in stride. Respond to feedback with “sounds good, thanks” instead of “I know.”
...
-   **Be humble** - In your subI presentation include more 'we' instead of 'I', thank mentors. When you don't know, say - “I don't know.”
